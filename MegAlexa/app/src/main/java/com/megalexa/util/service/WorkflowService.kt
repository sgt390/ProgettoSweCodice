 ...
 *  Ludovico Brocca || 2019-02-28      || File created
 *  Mirko Franco    || 2019-03-04      || Verifying code
 * /
 *
 */
        ...
        for (i in 0.. (blocks.length() - 1)){
            workflow.addBlock(
                when(blocks.getJSONObject(i).get("blockType")){
                    ...
                    "Calendar" -> BlockCalendarService.convertFromJSON(blocks.getJSONObject(i))
